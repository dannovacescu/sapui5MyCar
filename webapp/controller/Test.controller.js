sap.ui.define([
	...
	var PageController = Controller.extend("MyCars.MyCars.controller.Test", {

		onInit: function (oEvent) {

			// Set the initial form to be the display one
			this._showFormFragment("DisplayITP");

			// to navigate to the page on phone and not show the split screen items
			var oSplitContainer = this.byId("FormSplitscreenTest");
			oSplitContainer.toDetail(this.createId("pageTest"));
			...
			oModel.read("/zmasinaSet",
				...
				function (oData, oResponse) {
					var form1 = that.getView().byId("masterTest");
					var form2 = that.getView().byId("FormDisplayITP");
		...
		handleMasterList: function (oEvent) {
			...
			oModel.read("/zmasinaSet",
				...
				function (oData, oResponse) {
					...
					var form = that.getView().byId("FormDisplayITP");
