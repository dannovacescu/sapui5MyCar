sap.ui.define([
	...
	var PageController = Controller.extend("MyCars.MyCars.controller.Card", {

		onInit: function (oEvent) {
			// Set the initial form to be the display one
			this._showFormFragment("CardDisplay");

			// to navigate to the page on phone and not show the split screen items
			var oSplitContainer = this.byId("FormSplitscreenCard");
			oSplitContainer.toDetail(this.createId("pageCard"));
			...
			this.oModel.read("/zcardSet",
				null,
				null,
				false,
				function (oData, oResponse) {
					var form1 = that.getView().byId("masterCard");
					var form2 = that.getView().byId("FormDisplayCard");

					// create JSON model
					var oJSONModel = new sap.ui.model.json.JSONModel();
					oJSONModel.setProperty("/Cards", oData.results);
					var oODataJSONModel1 = new sap.ui.model.json.JSONModel();

					form1.setModel(oJSONModel, "card");
		...
		handleMasterList: function (oEvent) {
			...
			this.oModel.read("/zcardSet",
				...
				function (oData, oResponse) {
					...
					var form = that.getView().byId("FormDisplayCard");
		...
		handleEditPress: function (oEvent) {
			...
			var form = that.getView().byId("FormChangeCard");
		...
		handleDeletePress: function (oEvent) {
			...
			oModelDelete.remove("/zcardSet(Id=" + id + ",Users='I1234')", {
		...
		_toggleButtonsAndView: function (bEdit) {
			...
			this._showFormFragment(bEdit ? "CardChange" : "CardDisplay");
		},
