sap.ui.define([
	...
	return Controller.extend("MyCars.MyCars.controller.MyRovinieta", {
		...
		onInit: function () {
			...
			oModel1.read("/zmasinaSet",
				...
				function (oData, oResponse) {
					var form1 = that.getView().byId("masterRovinieta");
					var form2 = that.getView().byId("FormDisplayRovinieta");
					...
					form2.setModel(oODataJSONModel1, "localModel1");
		...
		handleMasterCasco: function (oEvent) {
			...
			oModel1.read("/zmasinaSet",
				...
				function (oData, oResponse) {
					...
					var form = that.getView().byId("FormDisplayRovinieta");

					// create JSON model
					var oJModel = new sap.ui.model.json.JSONModel();
					form.setModel(oJModel, "localModel1");
		...
		handleCarPress: function (oEvent) {
			this.getRouter().navTo("rovinieta");
		}
